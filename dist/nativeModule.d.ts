 ...
 * ```
 */
export declare function registerOutbrain(partnerKey: string): Promise<boolean>;
/**
 ...
 */
export declare function setTestMode(enabled: boolean): void;
/**
 ...
 */
export declare function setTestLocation(location: string): void;
/**
 ...
 */
export declare function setDisplayTest(enabled: boolean): void;
