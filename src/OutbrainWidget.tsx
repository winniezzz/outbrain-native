...
export function OutbrainWidget(props: OutbrainWidgetProps) {
  ...
  const html = useMemo(
    () => buildWidgetHtml({ ...widgetProps, darkMode, handler }),
    [
          ...
          case "recClick": {
            ...
            if (handler?.onRecClick) {
              ...
              Linking.openURL(url).catch((err) =>
                console.warn("OutbrainWidget: Failed to open URL", err)
              );
            }
            break;
          }
  ...
  return (
    <View style={[containerStyle, style]}>
      <WebView
        ref={webViewRef}
        source={{ html, baseUrl: "https://widgets.outbrain.com" }}
